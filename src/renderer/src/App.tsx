...
import { syncProtectedSongsWithMain } from './components/SongsPage/AddOnlineSongToPlaylistPrompt';
import { onlineQueueManager } from './other/onlineQueueManager';
...
export default function App() {
  ...
  useEffect(() => {
    initializeQueue();
    // Sync protected playlist songs with main process for cache protection
  ...
  // Set up the online queue manager with the player instance for global skip controls
  useEffect(() => {
    onlineQueueManager.setPlayer(player);
  }, [player]);
