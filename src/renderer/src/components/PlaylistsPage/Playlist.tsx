...
import { getOnlineSongsForPlaylist } from '../SongsPage/AddOnlineSongToPlaylistPrompt';
...
export const Playlist = (props: PlaylistProp) => {
  ...
  // Get online songs count for this playlist
  const onlineSongsCount = useMemo(() => {
    return getOnlineSongsForPlaylist(props.playlistId).length;
  }, [props.playlistId]);

  const totalSongsCount = props.songs.length + onlineSongsCount;
    ...
    return [
      ...
      },
      {
        ...
        handlerFunction: () => {
          changePromptMenuData(
            true,
            <PlaylistEditor existingPlaylist={props} />
          );
        },
        isDisabled: isMultipleSelectionsEnabled
          ? true
    ...
    (): ContextMenuAdditionalData =>
      ...
      isAMultipleSelection
        ...
        : {
            ...
            subTitle: t('common.songWithCount', { count: totalSongsCount })
          },
    [
      isAMultipleSelection,
      isMultipleSelectionEnabled,
    ...
    >
      ...
      <div className="playlist-info-container mt-2">
        ...
        <div className="playlist-no-of-songs text-sm font-light">
          {t('common.songWithCount', { count: totalSongsCount })}
          {onlineSongsCount > 0 && (
