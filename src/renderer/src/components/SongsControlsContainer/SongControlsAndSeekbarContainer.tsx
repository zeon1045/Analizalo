...
const SongControlsAndSeekbarContainer = () => {
  const isAFavorite = useStore(store, (state) => state.currentSongData?.isAFavorite ?? false);
  const isKnownSource = useStore(store, (state) => state.currentSongData?.isKnownSource ?? false);
